  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white/70 backdrop-blur-xl rounded-2xl border border-outlineVariant/40 shadow-sm p-6 text-center max-w-lg mx-auto">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-secondary to-secondary-600 mx-auto flex items-center justify-center text-white font-bold text-2xl">
        ...
        <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-bold bg-secondary/10 text-secondary border border-secondary/20 mt-3 capitalize">
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-background border border-outlineVariant/60 rounded-xl focus:ring-2 focus:ring-secondary/10 focus:border-secondary text-sm outline-none transition-all"
            />
          </div>
      ...
      <div className="flex justify-center w-full">
        <button
          onClick={handleSave}
          disabled={saving}
          className="px-8 py-3 bg-secondary text-white rounded-xl text-sm font-bold hover:bg-secondary-600 transition-all disabled:opacity-50 flex items-center gap-2"
        >
